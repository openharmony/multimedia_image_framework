...
public:
    ...
    static bool RGBToNV21P010(const uint8_t *srcBuffer, const RGBDataInfo &rgbInfo, DestConvertInfo &destInfo,
                              [[maybe_unused]]ColorSpace colorSpace);
    static bool RGBAF16ToNV12P010(const uint8_t *srcBuffer, const RGBDataInfo &rgbInfo, DestConvertInfo &destInfo,
                                  [[maybe_unused]]ColorSpace colorSpace);
    static bool RGBAF16ToNV21P010(const uint8_t *srcBuffer, const RGBDataInfo &rgbInfo, DestConvertInfo &destInfo,
                                  [[maybe_unused]]ColorSpace colorSpace);
    static bool RGBA1010102ToNV12(const uint8_t *srcBuffer, const RGBDataInfo &rgbInfo, DestConvertInfo &destInfo,
                                  [[maybe_unused]]ColorSpace colorSpace);
    static bool RGBA1010102ToNV12P010(const uint8_t *srcBuffer, const RGBDataInfo &rgbInfo, DestConvertInfo &destInfo,
                                      [[maybe_unused]]ColorSpace colorSpace);
    static bool RGBA1010102ToNV21P010(const uint8_t *srcBuffer, const RGBDataInfo &rgbInfo, DestConvertInfo &destInfo,
                                      [[maybe_unused]]ColorSpace colorSpace);
    ...
    static bool NV12P010ToNV21(const uint8_t *srcBuffer, const YUVDataInfo &yDInfo, DestConvertInfo &destInfo,
                               [[maybe_unused]]ColorSpace colorSpace);
    static bool NV12P010ToNV21P010(const uint8_t *srcBuffer, const YUVDataInfo &yDInfo, DestConvertInfo &destInfo,
                                   [[maybe_unused]]ColorSpace colorSpace);
    ...
    static bool NV12P010ToRGB888(const uint8_t *srcBuffer, const YUVDataInfo &yDInfo, DestConvertInfo &destInfo,
                                 [[maybe_unused]]ColorSpace colorSpace);
    static bool NV12P010ToRGBAF16(const uint8_t *srcBuffer, const YUVDataInfo &yDInfo, DestConvertInfo &destInfo,
                                  [[maybe_unused]]ColorSpace colorSpace);
    ...
    static bool NV21P010ToNV21(const uint8_t *srcBuffer, const YUVDataInfo &yDInfo, DestConvertInfo &destInfo,
                               [[maybe_unused]]ColorSpace colorSpace);
    static bool NV21P010ToNV12P010(const uint8_t *srcBuffer, const YUVDataInfo &yDInfo, DestConvertInfo &destInfo,
                                   [[maybe_unused]]ColorSpace colorSpace);
    ...
    static bool NV21P010ToRGB888(const uint8_t *srcBuffer, const YUVDataInfo &yDInfo, DestConvertInfo &destInfo,
                                 [[maybe_unused]]ColorSpace colorSpace);
    static bool NV21P010ToRGBAF16(const uint8_t *srcBuffer, const YUVDataInfo &yDInfo, DestConvertInfo &destInfo,
                                  [[maybe_unused]]ColorSpace colorSpace);
    static bool RGBAF16ToNV21(const uint8_t *srcBuffer, const RGBDataInfo &rgbInfo, DestConvertInfo &destInfo,
                              [[maybe_unused]]ColorSpace colorSpace);
    ...
    static bool BGRAToNV21(const uint8_t *srcBuffer, const RGBDataInfo &rgbInfo, DestConvertInfo &destInfo,
                           [[maybe_unused]]ColorSpace colorSpace);
    static bool RGBAF16ToNV12(const uint8_t *srcBuffer, const RGBDataInfo &rgbInfo, DestConvertInfo &destInfo,
                              [[maybe_unused]]ColorSpace colorSpace);
    ...
    static bool NV21ToNV12(const uint8_t *srcBuffer, const YUVDataInfo &yDInfo, DestConvertInfo &destInfo,
                           [[maybe_unused]]ColorSpace colorSpace);
    static bool NV21ToRGBAF16(const uint8_t *srcBuffer, const YUVDataInfo &yDInfo, DestConvertInfo &destInfo,
                              [[maybe_unused]]ColorSpace colorSpace);
    static bool NV12ToNV21(const uint8_t *srcBuffer, const YUVDataInfo &yDInfo, DestConvertInfo &destInfo,
                           [[maybe_unused]]ColorSpace colorSpace);
    static bool NV12ToRGBAF16(const uint8_t *srcBuffer, const YUVDataInfo &yDInfo, DestConvertInfo &destInfo,
                              [[maybe_unused]]ColorSpace colorSpace);

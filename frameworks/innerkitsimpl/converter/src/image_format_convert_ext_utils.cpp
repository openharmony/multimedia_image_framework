...
static bool RGB565ToNV12P010NoManual(const uint8_t *srcBuffer, const Size &imageSize,
...
bool ImageFormatConvertExtUtils::RGB565ToNV12P010(const uint8_t *srcBuffer, const Size &imageSize,
    uint8_t **destBuffer, size_t &destBufferSize, [[maybe_unused]] ColorSpace colorSpace)
{
    if (srcBuffer == nullptr || destBuffer == nullptr || imageSize.width < 0 || imageSize.height < 0) {
        IMAGE_LOGE("Input parameters not compliant!");
...
static bool RGB565ToNV21P010NoManual(const uint8_t *srcBuffer, const Size &imageSize,
    uint8_t **destBuffer, size_t &destBufferSize)
{
    uint8_t *yu12Buffer = new (std::nothrow) uint8_t[destBufferSize / NUM_2];
    if (yu12Buffer == nullptr) {
...
bool ImageFormatConvertExtUtils::RGB565ToNV21P010(const uint8_t *srcBuffer, const Size &imageSize,
    uint8_t **destBuffer, size_t &destBufferSize, [[maybe_unused]] ColorSpace colorSpace)
{
    if (srcBuffer == nullptr || destBuffer == nullptr || imageSize.width < 0 || imageSize.height < 0) {
        IMAGE_LOGE("Input parameters not compliant!");
...
bool ImageFormatConvertExtUtils::RGBAToNV12P010(const uint8_t *srcBuffer, const Size &imageSize, uint8_t **destBuffer,
    size_t &destBufferSize, [[maybe_unused]] ColorSpace colorSpace)
{
...
bool ImageFormatConvertExtUtils::RGBAToNV21P010(const uint8_t *srcBuffer, const Size &imageSize, uint8_t **destBuffer,
    size_t &destBufferSize, [[maybe_unused]] ColorSpace colorSpace)
{
    if (srcBuffer == nullptr || destBuffer == nullptr || imageSize.width < NUM_0 || imageSize.height < NUM_0) {
        return false;
...
bool ImageFormatConvertExtUtils::BGRAToNV12P010(const uint8_t *srcBuffer, const Size &imageSize, uint8_t **destBuffer,
    size_t &destBufferSize, [[maybe_unused]] ColorSpace colorSpace)
{
    if (srcBuffer == nullptr || destBuffer == nullptr || imageSize.width < 0 || imageSize.height < 0) {
        return false;
...
bool ImageFormatConvertExtUtils::BGRAToNV21P010(const uint8_t *srcBuffer, const Size &imageSize, uint8_t **destBuffer,
    size_t &destBufferSize, [[maybe_unused]] ColorSpace colorSpace)
{
    if (srcBuffer == nullptr || destBuffer == nullptr || imageSize.width < 0 || imageSize.height < 0) {
        return false;
...
bool ImageFormatConvertExtUtils::RGBToNV12P010(const uint8_t *srcBuffer, const Size &imageSize, uint8_t **destBuffer,
    size_t &destBufferSize, [[maybe_unused]] ColorSpace colorSpace)
{
    if (srcBuffer == nullptr || destBuffer == nullptr || imageSize.width < NUM_0 || imageSize.height < NUM_0) {
        return false;
...
static bool RGBToNV21P010NoManual(const uint8_t *srcBuffer, const Size &imageSize,
    uint8_t **destBuffer, size_t &destBufferSize)
{
    uint8_t *yu12Buffer(new (std::nothrow) uint8_t[imageSize.width * imageSize.height +
        (imageSize.width + NUM_1) / NUM_2 * (imageSize.height + NUM_1) / NUM_2 * NUM_2]());
...
bool ImageFormatConvertExtUtils::RGBToNV21P010(const uint8_t *srcBuffer, const Size &imageSize,
    uint8_t **destBuffer, size_t &destBufferSize, [[maybe_unused]] ColorSpace colorSpace)
{
    if (srcBuffer == nullptr || destBuffer == nullptr || imageSize.width < NUM_0 || imageSize.height < NUM_0) {
        return false;
...
static bool RGBA1010102ToNV12NoManual(const uint8_t *srcBuffer, const Size &imageSize, uint8_t **destBuffer)
{
...
bool ImageFormatConvertExtUtils::RGBA1010102ToNV12(const uint8_t *srcBuffer, const Size &imageSize,
    uint8_t **destBuffer, size_t &destBufferSize, [[maybe_unused]] ColorSpace colorSpace)
{
    if (srcBuffer == nullptr || destBuffer == nullptr || imageSize.width < NUM_0 || imageSize.height < NUM_0) {
        return false;
...
static bool RGBA1010102ToNV21NoManual(const uint8_t *srcBuffer, const Size &imageSize, uint8_t **destBuffer)
{
    uint8_t *i420Buffer = new (std::nothrow) uint8_t[imageSize.width * imageSize.height +
        (((imageSize.width + NUM_1) / NUM_2) * ((imageSize.height + NUM_1) / NUM_2)) * NUM_2];
    if (i420Buffer == nullptr) {
...
bool ImageFormatConvertExtUtils::RGBA1010102ToNV21(const uint8_t *srcBuffer, const Size &imageSize,
    uint8_t **destBuffer, size_t &destBufferSize, [[maybe_unused]] ColorSpace colorSpace)
{
    if (srcBuffer == nullptr || destBuffer == nullptr || imageSize.width < NUM_0 || imageSize.height < NUM_0) {
        return false;

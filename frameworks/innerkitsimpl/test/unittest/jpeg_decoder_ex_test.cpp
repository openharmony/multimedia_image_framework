 ...
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, CopyItemTest0001, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: CopyItemTest0001 start";
...
/**
 * @tc.name: GetValueTest0002
 * @tc.desc: Test of GetValue
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, GetValueTest0002, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: GetValueTest0002 start";
    auto ExifMakerNote = std::make_shared<ExifMakerNote::ExifItem>();
    std::string value = "111";
    ExifByteOrder order;
    bool mock = true;
    ExifMakerNote->GetValue(value, order, mock);
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: GetValueTest0002 end";
}

/**
 * @tc.name: GetValueTest0003
 * @tc.desc: Test of GetValue
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, GetValueTest0003, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: GetValueTest0003 start";
    auto ExifMakerNote = std::make_shared<ExifMakerNote::ExifItem>();
    std::string value = "111";
    auto *exifData = exif_data_new();
    ExifData* exifDataPtr = new ExifData;
    bool mock = true;
    ExifMakerNote->GetValue(value, exifData, mock);
    exif_data_unref(exifData);
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: GetValueTest0003 end";
}

/**
 * @tc.name: DumpTest0004
 * @tc.desc: Test of Dump
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, DumpTest0004, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: DumpTest0004 start";
    auto ExifMakerNote = std::make_shared<ExifMakerNote::ExifItem>();
    std::string info = "nihao";
    ExifByteOrder order;
    ExifMakerNote::ExifItem item;
    ExifMakerNote->Dump(info, order);
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: DumpTest0004 end";
}

/**
 * @tc.name: GetValueTest0005
 * @tc.desc: Test of GetValue
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, GetValueTest0005, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: GetValueTest0005 start";
    auto ExifMakerNote = std::make_shared<ExifMakerNote::ExifItem>();
    std::string value ="111";
    ExifByteOrder order;
    ExifMakerNote::ExifItem item;
    ...
    ASSERT_EQ(ret, true);
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: GetValueTest0005 end";
}

/**
 * @tc.name: GetValueTest0006
 * @tc.desc: Test of GetValue
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, GetValueTest0006, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: GetValueTest0006 start";
    auto ExifMakerNote = std::make_shared<ExifMakerNote::ExifItem>();
    std::string value = "111";
    auto* exifData = exif_data_new();
    ExifMakerNote::ExifItem item;
    ...
    ASSERT_EQ(ret, true);
    exif_data_unref(exifData);
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: GetValueTest0006 end";
}

/**
 * @tc.name: GetValueTest0007
 * @tc.desc: Test of GetValue
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, GetValueTest0007, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: GetValueTest0007 start";
    auto ExifMakerNote = std::make_shared<ExifMakerNote::ExifItem>();
    std::string value "111";
    auto *exifContent = exif_content_new();
    ExifMakerNote::ExifItem item;
    bool mock =true;
    bool ret = ExifMakerNote->GetValue(value, exifConten, item, mock);
    ASSERT_EQ(ret, true);
    exif_content_unref(exifContent);
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: GetValueTest0007 end";
}

/**
 * @tc.name: GetValueTest0008
 * @tc.desc: Test of GetValue
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, GetValueTest0008, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: GetValueTest0008 start";
    auto ExifMakerNote = std::make_shared<ExifMakerNote::ExifItem>();
    std::string value = "111";
    auto *exifEntry = exif_entry_new();
    ExifMakerNote::ExifItem item;
    bool mock =true;
    bool ret = ExifMakerNote->GetValue(value, exifEntry, item, mock);
    ASSERT_EQ(ret, true);
    exif_entry_unref(exifEntry);
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: GetValueTest0008 end";
}

/**
 * @tc.name: DumpTest0009
 * @tc.desc: Test of Dump
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, DumpTest0009, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: DumpTest0009 start";
    auto ExifMakerNote = std::make_shared<ExifMakerNote::ExifItem>();
    std::string info = "infomation";
    ExifMakerNote::ExifItem item;
    ExifByteOrder order;
    ExifMakerNote->Dump(info, item, order);
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: DumpTest0009 end";
}

/**
 * @tc.name: ParserTest0010
 * @tc.desc: Test of Parser
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, ParserTest0010, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: ParserTest0010 start";
    auto ExifMakerNote = std::make_shared<ExifMakerNote>();
    auto* exifData = exif_data_new();
    const unsigned char* data = "infomation";
    uint32_t size = 11;
    uint32_t result = ExifMakerNote->Parser(exif, data, size);
    exif_data_unref(exifData);
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: ParserTest0010 end";
}

/**
 * @tc.name: FindExifLocationTest0011
 * @tc.desc: Test of FindExifLocation
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, FindExifLocationTest0011, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: FindExifLocationTest0011 start";
    auto ExifMakerNote = std::make_shared<ExifMakerNote>();
    unsigned char *data = "ex";
    uint32_t size = 3;
    unsigned char *&newData = "Amireco";
    uint32_t newSize = 7;
    uint32_t result = ExifMakerNote->FindExifLocation(data, size, newData, newSize);
    ASSERT_EQ(result, false);
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: FindExifLocationTest0011 end";
}

/**
 * @tc.name: FindExifLocationTest0012
 * @tc.desc: Test of FindExifLocation
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, FindExifLocationTest0012, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: FindExifLocationTest0012 start";
    auto ExifMakerNote = std::make_shared<ExifMakerNote>();
    unsigned char *data = {'E', 'x', 'i', 'f', '\0', '\0'};
    uint32_t size = 6;
    unsigned char *&newData = "Amireco";
    uint32_t newSize = 7;
    ExifMakerNote->FindExifLocation(data, size, newData, newSize);
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: FindExifLocationTest0012 end";
}

/**
 * @tc.name: FindExifLocationTest0013
 * @tc.desc: Test of FindExifLocation
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, FindExifLocationTest0013, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: FindExifLocationTest0013 start";
    auto ExifMakerNote = std::make_shared<ExifMakerNote>();
    unsigned char *data = "exportsctest";
    uint32_t size = 13;
    unsigned char *&newData = "Amireco";
    uint32_t newSize = 7;
    uint32_t result = ExifMakerNote->FindExifLocation(data, size, newData, newSize);
    ASSERT_EQ(result, false);
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: FindExifLocationTest0013 end";
}

/**
 * @tc.name: FindJpegAPP1Test0014
 * @tc.desc: Test of FindJpegAPP1
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, FindJpegAPP1Test0014, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: FindJpegAPP1Test0014 start";
    auto ExifMakerNote = std::make_shared<ExifMakerNote>();
    unsigned char *data = {'0xff', '0xd8', '0xe1', '0xfb'};
    uint32_t size = 4;
    unsigned char *&newData = "Amireco";
    uint32_t newSize = 7;
    uint32_t result = ExifMakerNote->FindJpegAPP1(data, size, newData, newSize);
    ASSERT_EQ(result, false);
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: FindJpegAPP1Test0014 end";
}

/**
 * @tc.name: FindJpegAPP1Test0015
 * @tc.desc: Test of FindJpegAPP1
 * @tc.type: FUNC
 */
HWTEST_F(ExifMakerNote, FindJpegAPP1Test0015, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: FindJpegAPP1Test0015 start";
    auto ExifMakerNote = std::make_shared<ExifMakerNote>();
    unsigned char *data = {'0xff', '0xd8'};
    uint32_t size = 2;
    unsigned char *&newData = "Amireco";
    uint32_t newSize = 7;
    uint32_t result = ExifMakerNote->FindJpegAPP1(data, size, newData, newSize);
    ASSERT_EQ(result, false);
    GTEST_LOG_(INFO) << "ExifMakerNoteTest: FindJpegAPP1Test0015 end";
}
}
}
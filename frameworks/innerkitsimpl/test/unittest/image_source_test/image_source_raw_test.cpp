...
static const std::string IMAGE_INPUT_DNG_WITH_JPG_PREVIEW_PATH = "/data/local/tmp/image/dng_with_jpg.dng";
...
/**
 * @tc.name: DngImageDecode001
 * @tc.desc: Decode dng image with jpg from file source stream(default:RGBA_8888)
 * @tc.type: FUNC
 */
HWTEST_F(ImageSourceRawTest, DngImageDecode001, TestSize.Level3)
{
    /**
    * @tc.steps: step1. create image source by correct raw file path and format hit.
    * @tc.expected: step1. create image source success.
    */
    ...
    SourceOptions opts;
    opts.formatHint = "image/x-raw";
    std::unique_ptr<ImageSource> imageSource = ImageSource::CreateImageSource(IMAGE_INPUT_DNG_WITH_JPG_PREVIEW_PATH,
                                                                              opts, errorCode);
    ASSERT_EQ(errorCode, SUCCESS);
    ASSERT_NE(imageSource.get(), nullptr);
    /**
...
/**
 * @tc.name: DngImageDecode002
 * @tc.desc: Decode dng image with jpg from file source stream(BGRA_8888)
 * @tc.type: FUNC
 */
HWTEST_F(ImageSourceRawTest, DngImageDecode002, TestSize.Level3)
{
    /**
     * @tc.steps: step1. create image source by correct file path and format hit.
     * @tc.expected: step1. create image source success.
...
/**
 * @tc.name: DngImageDecode003
 * @tc.desc: Decode dng image with jpg from file source stream(RGB_565)
 * @tc.type: FUNC
 */
HWTEST_F(ImageSourceRawTest, DngImageDecode003, TestSize.Level3)
{
    /**
     * @tc.steps: step1. create image source by correct file path.
     * @tc.expected: step1. create image source success.
...
/**
 * @tc.name: DngImageDecode004
 * @tc.desc: Decode Dng image with jpg from file source stream(ARGB_8888)
 * @tc.type: FUNC
 */
HWTEST_F(ImageSourceRawTest, DngImageDecode004, TestSize.Level3)
{
    /**
     * @tc.steps: step1. create image source by correct file path and format hit.
     * @tc.expected: step1. create image source success.
...
/**
 * @tc.name: DngImageDecode005
 * @tc.desc: Create dng source by correct file path and default format hit.
 * @tc.type: FUNC
 */
HWTEST_F(ImageSourceRawTest, DngImageDecode005, TestSize.Level3)
{
    /**
     * @tc.steps: step1. create image source by correct file path and default format hit.
     * @tc.expected: step1. create image source success.
    ...
    ASSERT_EQ(ret, SUCCESS);
    ret = imageSource->GetImageInfo(imageInfo);
    ASSERT_EQ(imageInfo.size.width, 4032);
    ASSERT_EQ(imageInfo.size.height, 3024);
}

/**
 * @tc.name: DngImageDecode006
 * @tc.desc: Create image source by correct dng file path and wrong format hit.
 * @tc.type: FUNC
 */
HWTEST_F(ImageSourceRawTest, DngImageDecode006, TestSize.Level3)
{
    /**
     * @tc.steps: step1. create image source by correct file path and wrong format hit.
     * @tc.expected: step1. create image source success.
...
/**
 * @tc.name: DngImageDecode007
 * @tc.desc: Decode dng image from buffer source stream
 * @tc.type: FUNC
 */
HWTEST_F(ImageSourceRawTest, DngImageDecode007, TestSize.Level3)
{
    /**
     * @tc.steps: step1. create image source by buffer source stream and default format hit
     * @tc.expected: step1. create image source success.
     */
    size_t bufferSize = 0;
    bool ret = ImageUtils::GetFileSize(IMAGE_INPUT_DNG_WITH_JPG_PREVIEW_PATH, bufferSize);
    ASSERT_EQ(ret, true);
    auto *buffer = reinterpret_cast<uint8_t *>(malloc(bufferSize));
    ASSERT_NE(buffer, nullptr);
    ret = OHOS::ImageSourceUtil::ReadFileToBuffer(IMAGE_INPUT_DNG_WITH_JPG_PREVIEW_PATH, buffer, bufferSize);
    ASSERT_EQ(ret, true);
    uint32_t errorCode = 0;
    SourceOptions opts;
    std::unique_ptr<ImageSource> imageSource = ImageSource::CreateImageSource(buffer, bufferSize, opts, errorCode);
...
/**
 * @tc.name: DngImageDecode008
 * @tc.desc: Decode dng image from istream source stream
 * @tc.type: FUNC
 */
HWTEST_F(ImageSourceRawTest, DngImageDecode008, TestSize.Level3)
{
    /**
     * @tc.steps: step1. create image source by istream source stream and default format hit
     * @tc.expected: step1. create image source success.
     */
    std::unique_ptr<std::fstream> fs = std::make_unique<std::fstream>();
    fs->open(IMAGE_INPUT_DNG_WITH_JPG_PREVIEW_PATH, std::fstream::binary | std::fstream::in);
    bool isOpen = fs->is_open();
    ASSERT_EQ(isOpen, true);
    uint32_t errorCode = 0;
    SourceOptions opts;
...
/**
 * @tc.name: DngImageDecode009
 * @tc.desc: Decode raw image multiple times from one imageSource
 * @tc.type: FUNC
 */
HWTEST_F(ImageSourceRawTest, DngImageDecode009, TestSize.Level3)
{
    /**
     * @tc.steps: step1. create image source by file path.
     * @tc.expected: step1. create image source success.
...
/**
 * @tc.name: DngImageDecode010
 * @tc.desc: Decode wrong raw image from one imageSource
 * @tc.type: FUNC
 */
HWTEST_F(ImageSourceRawTest, DngImageDecode010, TestSize.Level3)
{
    /**
     * @tc.steps: step1. create image source by buffer source stream and default format hit, modify data buffer to wrong
     * format.

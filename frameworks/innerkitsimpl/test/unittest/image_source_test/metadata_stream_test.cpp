...
/**
 * @tc.name: BufferMetadataStream_ReadByte001
 * @tc.desc: test the ReadByte function of BufferMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, BufferMetadataStream_ReadByte001, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_ReadByte001 start";
    byte *originData = nullptr;
    size_t size = 4;
    BufferMetadataStream::MemoryMode mode = BufferMetadataStream::MemoryMode::Dynamic;
    int originalFd = 0;
    const std::string &originalPath = "/data/local/tmp/image/test.txt";
    BufferMetadataStream stream = BufferMetadataStream(originData, size, mode, originalFd, originalPath);
    int ret = stream.ReadByte();
    ASSERT_EQ(ret, -1);
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_ReadByte001 end";
}

/**
 * @tc.name: BufferMetadataStream_ReadByte002
 * @tc.desc: test the ReadByte function of BufferMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, BufferMetadataStream_ReadByte002, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_ReadByte002 start";
    byte originData[4] = {1, 2, 3, 4};
    size_t size = 4;
    BufferMetadataStream::MemoryMode mode = BufferMetadataStream::MemoryMode::Dynamic;
    int originalFd = 0;
    const std::string &originalPath = "/data/local/tmp/image/test.txt";
    BufferMetadataStream stream = BufferMetadataStream(originData, size, mode, originalFd, originalPath);
    stream.currentOffset_ = 128;
    int ret = stream.ReadByte();
    ASSERT_EQ(ret, -1);
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_ReadByte002 end";
}

/**
 * @tc.name: BufferMetadataStream_Seek001
 * @tc.desc: test the Seek function of BufferMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, BufferMetadataStream_Seek001, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_Seek001 start";
    byte originData[4] = {1, 2, 3, 4};
    size_t size = 4;
    BufferMetadataStream::MemoryMode mode = BufferMetadataStream::MemoryMode::Dynamic;
    int originalFd = 0;
    ...
    BufferMetadataStream stream = BufferMetadataStream(originData, size, mode, originalFd, originalPath);
    long offset = 0;
    SeekPos pos = SeekPos::END;
    long ret = stream.Seek(offset, pos);
    ASSERT_EQ(ret, 4);
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_Seek001 end";
}

/**
 * @tc.name: BufferMetadataStream_Seek002
 * @tc.desc: test the Seek function of BufferMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, BufferMetadataStream_Seek002, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_Seek002 start";
    byte originData[4] = {1, 2, 3, 4};
    size_t size = 4;
    BufferMetadataStream::MemoryMode mode = BufferMetadataStream::MemoryMode::Dynamic;
    int originalFd = 0;
    ...
    BufferMetadataStream stream = BufferMetadataStream(originData, size, mode, originalFd, originalPath);
    long offset = 128;
    SeekPos pos = SeekPos::BEGIN;
    long ret = stream.Seek(offset, pos);
    ASSERT_EQ(ret, 4);
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_Seek002 end";
}

/**
 * @tc.name: BufferMetadataStream_Read002
 * @tc.desc: test the Read function of BufferMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, BufferMetadataStream_Read002, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_Read002 start";
    byte originData[4] = {1, 2, 3, 4};
    size_t size = 4;
    BufferMetadataStream::MemoryMode mode = BufferMetadataStream::MemoryMode::Dynamic;
    int originalFd = 0;
    ...
    ssize_t ret = stream.Read(buf, size);
    ASSERT_EQ(ret, -1);
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_Read002 end";
}

/**
 * @tc.name: BufferMetadataStream_Read003
 * @tc.desc: test the Read function of BufferMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, BufferMetadataStream_Read003, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_Read003 start";
    byte originData[4] = {1, 2, 3, 4};
    size_t size = 4;
    BufferMetadataStream::MemoryMode mode = BufferMetadataStream::MemoryMode::Dynamic;
    int originalFd = 0;
    ...
    ssize_t ret = stream.Read(buf, size);
    ASSERT_EQ(ret, -1);
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_Read003 end";
}

/**
 * @tc.name: BufferMetadataStream_CopyFrom006
 * @tc.desc: test the CopyFrom function of BufferMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, BufferMetadataStream_CopyFrom006, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_CopyFrom006 start";
    BufferMetadataStream src;
    BufferMetadataStream dest;
    bool ret = dest.CopyFrom(src);
    ASSERT_EQ(ret, true);
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_CopyFrom006 end";
}

/**
 * @tc.name: BufferMetadataStream_CopyFrom007
 * @tc.desc: test the CopyFrom function of BufferMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, BufferMetadataStream_CopyFrom007, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_CopyFrom007 start";
    BufferMetadataStream src;
    byte originData[4] = {1, 2, 3, 4};
    size_t size = 4;
    BufferMetadataStream::MemoryMode mode = BufferMetadataStream::MemoryMode::Fix;
    int originalFd = 0;
    const std::string &originalPath = "/data/local/tmp/image/test.txt";
    BufferMetadataStream dest = BufferMetadataStream(originData, size, mode, originalFd, originalPath);
    dest.capacity_ = 0;
    src.bufferSize_ = 8;
    bool ret = dest.CopyFrom(src);
    ASSERT_EQ(ret, false);
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_CopyFrom007 end";
}

/**
 * @tc.name: BufferMetadataStream_CalculateNewCapacity001
 * @tc.desc: test the CalculateNewCapacity function of BufferMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, BufferMetadataStream_CalculateNewCapacity001, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_CalculateNewCapacity001 start";
    BufferMetadataStream src;
    byte originData[4] = {1, 2, 3, 4};
    size_t size = 4;
    BufferMetadataStream::MemoryMode mode = BufferMetadataStream::MemoryMode::Fix;
    ...
    stream.expandCount_ = 5;
    long ret = stream.CalculateNewCapacity(currentOffset, size);
    ASSERT_EQ(ret, BufferMetadataStream::METADATA_STREAM_CAPACITY_30MB);
    GTEST_LOG_(INFO) << "MetadataStreamTest: BufferMetadataStream_CalculateNewCapacity001 end";
}

/**
 * @tc.name: FileMetadataStream_Read003
 * @tc.desc: Test the Read function of FileMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, FileMetadataStream_Read003, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_Read003 start";
    const std::string &filePath = "";
    FileMetadataStream stream = FileMetadataStream(filePath);
    stream.fp_ = fopen("/data/local/tmp/image/test_exif.jpg", "rb");
    byte buffer[SIZE_1024];
    ssize_t ret = stream.Read(buffer, 0);
    ASSERT_EQ(ret, 0);
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_Read003 end";
}

/**
 * @tc.name: FileMetadataStream_ReadByte003
 * @tc.desc: Test the ReadByte function of FileMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, FileMetadataStream_ReadByte003, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_ReadByte003 start";
    const std::string &filePath = "/data/local/tmp/image/not_exist.jpg";
    FileMetadataStream stream = FileMetadataStream(filePath);
    int ret = stream.ReadByte();
    ASSERT_EQ(ret, -1);
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_ReadByte003 end";
}

/**
 * @tc.name: FileMetadataStream_Seek002
 * @tc.desc: Test the Seek function of FileMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, FileMetadataStream_Seek002, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_Seek002 start";
    const std::string &filePath = "/data/local/tmp/image/not_exist.jpg";
    FileMetadataStream stream = FileMetadataStream(filePath);
    long offset = 0;
    SeekPos pos = SeekPos::BEGIN;
    long ret = stream.Seek(offset, pos);
    ASSERT_EQ(ret, -1);
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_Seek002 end";
}

/**
 * @tc.name: FileMetadataStream_Tell001
 * @tc.desc: Test the Tell function of FileMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, FileMetadataStream_Tell001, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_Tell001 start";
    const std::string &filePath = "/data/local/tmp/image/not_exist.jpg";
    FileMetadataStream stream = FileMetadataStream(filePath);
    long ret = 0;
    ret = stream.Tell();
    ASSERT_EQ(ret, -1);
    stream.initPath_ = FileMetadataStream::INIT_FROM_FD;
    ret = stream.Tell();
    ASSERT_EQ(ret, -1);
    stream.initPath_ = FileMetadataStream::INIT_FROM_UNKNOWN;
    ret = stream.Tell();
    ASSERT_EQ(ret, -1);
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_Tell001 end";
}

/**
 * @tc.name: FileMetadataStream_OpenFromFD001
 * @tc.desc: Test the OpenFromFD function of FileMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, FileMetadataStream_OpenFromFD001, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_OpenFromFD001 start";
    const std::string &filePath = "/data/local/tmp/image/not_exist.jpg";
    FileMetadataStream stream = FileMetadataStream(filePath);
    const char *modeStr = "rb";
    bool ret = stream.OpenFromFD(modeStr);
    ASSERT_EQ(ret, false);
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_OpenFromFD001 end";
}

/**
 * @tc.name: FileMetadataStream_Open006
 * @tc.desc: Test the Open function of FileMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, FileMetadataStream_Open006, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_Open006 start";
    const std::string &filePath = "/data/local/tmp/image/not_exist.jpg";
    FileMetadataStream stream = FileMetadataStream(filePath);
    stream.initPath_ = FileMetadataStream::INIT_FROM_UNKNOWN;
    OpenMode mode = OpenMode::Read;
    bool ret = stream.Open(mode);
    ASSERT_EQ(ret, false);
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_Open006 end";
}

/**
 * @tc.name: FileMetadataStream_GetSize001
 * @tc.desc: Test the GetSize function of FileMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, FileMetadataStream_GetSize001, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_GetSize001 start";
    const std::string &filePath = "/data/local/tmp/image/not_exist.jpg";
    FileMetadataStream stream = FileMetadataStream(filePath);
    ssize_t ret = stream.GetSize();
    ASSERT_EQ(ret, -1);
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_GetSize001 end";
}

/**
 * @tc.name: FileMetadataStream_IsEof002
 * @tc.desc: Test the IsEof function of FileMetadataStream
 * @tc.type: FUNC
 */
HWTEST_F(MetadataStreamTest, FileMetadataStream_IsEof002, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "MetadataStreamTest: FileMetadataStream_IsEof002 start";
    const std::string &filePath = "/data/local/tmp/image/not_exist.jpg";
    FileMetadataStream stream = FileMetadataStream(filePath);

...
/**
 * @tc.name: CheckParams
 * @tc.desc: Test of  CheckParams
 * @tc.type: FUNC
 */
HWTEST_F(PixelMapTest, CheckParams, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ImagePixelMapTest: CheckParams  start";
    std::unique_ptr<PixelMap> pixelMap = std::make_unique<PixelMap>();
    uint32_t *colors = new uint32_t;
    ...
    opts.size.width = 1;
    opts.size.height = 1;
    bool ret = pixelMap->CheckParams(colors, colorLength, offset, stride, opts);
    ASSERT_EQ(ret, false);
    delete colors;
...
/**
 * @tc.name: ScalePixelMap
 * @tc.desc: Test of  ScalePixelMap
 * @tc.type: FUNC
 */
HWTEST_F(PixelMapTest, ScalePixelMap, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ImagePixelMapTest: ScalePixelMap  start";
    std::unique_ptr<PixelMap> pixelMap = std::make_unique<PixelMap>();
    Size targetSize;
    Size dstSize;
...
/**
 * @tc.name: CopyPixMapToDst
 * @tc.desc: Test of  CopyPixMapToDst
 * @tc.type: FUNC
 */
HWTEST_F(PixelMapTest, CopyPixMapToDst, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "ImagePixelMapTest: CopyPixMapToDst  start";
    std::unique_ptr<PixelMap> pixelMap = std::make_unique<PixelMap>();
    PixelMap source;

...
#ifndef FRAMEWORKS_INNERKITSIMPL_STREAM_INCLUDE_OSTREAM_PACKER_STREAM_H
#define FRAMEWORKS_INNERKITSIMPL_STREAM_INCLUDE_OSTREAM_PACKER_STREAM_H
...
#endif // FRAMEWORKS_INNERKITSIMPL_STREAM_INCLUDE_OSTREAM_PACKER_STREAM_H

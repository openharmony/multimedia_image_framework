 ...
 */
#ifndef FRAMEWORKS_INNERKITSIMPL_UTILS_INCLUDE_IMAGE_SYSTEM_PROPERTIES_H_
#define FRAMEWORKS_INNERKITSIMPL_UTILS_INCLUDE_IMAGE_SYSTEM_PROPERTIES_H_
...
#endif // FRAMEWORKS_INNERKITSIMPL_UTILS_INCLUDE_IMAGE_SYSTEM_PROPERTIES_H_

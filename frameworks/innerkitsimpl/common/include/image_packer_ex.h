...
#ifndef FRAMEWORKS_INNERKITSIMPL_COMMON_INCLUDE_IMAGE_PACKER_EX_H
#define FRAMEWORKS_INNERKITSIMPL_COMMON_INCLUDE_IMAGE_PACKER_EX_H
...
#endif // FRAMEWORKS_INNERKITSIMPL_COMMON_INCLUDE_IMAGE_PACKER_EX_H

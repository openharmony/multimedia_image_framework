...
#ifndef FRAMEWORKS_INNERKITSIMPL_COMMON_INCLUDE_MEMORY_MANAGER_H
#define FRAMEWORKS_INNERKITSIMPL_COMMON_INCLUDE_MEMORY_MANAGER_H
...
#endif // FRAMEWORKS_INNERKITSIMPL_COMMON_INCLUDE_MEMORY_MANAGER_H
...
#ifndef FRAMEWORKS_INNERKITSIMPL_ACCESSOR_INCLUDE_XMP_XMP_FD_IO_H
#define FRAMEWORKS_INNERKITSIMPL_ACCESSOR_INCLUDE_XMP_XMP_FD_IO_H
...
private:
    ...
    static void WriteAllOrThrow(int fd, const void *buffer, size_t size, const char *contextWrite);
    ...
    XMPFd_IO &operator=(const XMP_IO &in) = delete;
    DISALLOW_COPY(XMPFd_IO);
};
}  // namespace Media
}  // namespace OHOS
#endif // FRAMEWORKS_INNERKITSIMPL_ACCESSOR_INCLUDE_XMP_XMP_FD_IO_H

...
public:
    ...
    static std::unique_ptr<ImageSource> CreateImageSource(const int fd, uint32_t& errCode);
    static std::unique_ptr<ImageSource> CreateImageSourceWithOption(
        const int fd, SourceOptions& opts, uint32_t& errCode);
    static std::unique_ptr<ImageSource> CreateImageSource(const uint8_t* data, uint32_t size, uint32_t& errCode);
    static std::unique_ptr<ImageSource> CreateImageSourceWithOption(
    ...
    static std::tuple<std::unique_ptr<ImageSource>, std::unique_ptr<IncrementalPixelMap>> CreateIncrementalSource(

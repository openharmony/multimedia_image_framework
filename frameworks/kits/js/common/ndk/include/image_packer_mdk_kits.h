...
#ifndef FRAMEWORKS_KITS_JS_COMMON_INCLUDE_IMAGE_PACKER_MDK_KITS_H_
#define FRAMEWORKS_KITS_JS_COMMON_INCLUDE_IMAGE_PACKER_MDK_KITS_H_
...
#endif // FRAMEWORKS_KITS_JS_COMMON_INCLUDE_IMAGE_PACKER_MDK_KITS_H_

...
#ifndef FRAMEWORKS_KITS_JS_COMMON_INCLUDE_IMAGE_RECEIVER_NAPI_LISTENER_H_
#define FRAMEWORKS_KITS_JS_COMMON_INCLUDE_IMAGE_RECEIVER_NAPI_LISTENER_H_
...
#endif // FRAMEWORKS_KITS_JS_COMMON_INCLUDE_IMAGE_RECEIVER_NAPI_LISTENER_H_

...
#undef LOG_TAG
#define LOG_TAG "SendableImageReceiverNapi"
...
SendableImageReceiverNapi::SendableImageReceiverNapi():env_(nullptr)
{}

SendableImageReceiverNapi::~SendableImageReceiverNapi()
{
    release();
}
...
napi_value SendableImageReceiverNapi::Init(napi_env env, napi_value exports)
{
    IMAGE_FUNCTION_IN();
...
napi_value SendableImageReceiverNapi::Constructor(napi_env env, napi_callback_info info)
{
    ...
    auto reference = std::make_unique<SendableImageReceiverNapi>();
    reference->env_ = env;
...
void SendableImageReceiverNapi::Destructor(napi_env env, void *nativeObject, void *finalize)
{
    if (nativeObject != nullptr) {
        delete reinterpret_cast<SendableImageReceiverNapi*>(nativeObject);
...
napi_value SendableImageReceiverNapi::JSCreateImageReceiver(napi_env env, napi_callback_info info)
{
    napi_status status;
    napi_value constructor = nullptr;
    napi_value result = nullptr;
...
static bool CheckArgs(const SendableImageReceiverCommonArgs &args)
{
...
static bool PrepareOneArg(SendableImageReceiverCommonArgs &args, struct SendableImageReceiverInnerContext &ic)
{
    if (ic.argc == ARGS1) {
...
{
    IMAGE_FUNCTION_IN();
    struct SendableImageReceiverInnerContext ic;
    ic.argc = args.argc;
    ...
    if (args.async != CallType::STATIC) {
        ic.context = std::make_unique<SendableImageReceiverAsyncContext>();
...
napi_value SendableImageReceiverNapi::JsGetSize(napi_env env, napi_callback_info info)
{
    IMAGE_FUNCTION_IN();
    SendableImageReceiverCommonArgs args = {
        .env = env, .info = info,
...
napi_value SendableImageReceiverNapi::JsGetCapacity(napi_env env, napi_callback_info info)
{
    IMAGE_FUNCTION_IN();
    SendableImageReceiverCommonArgs args = {
        .env = env, .info = info,
...
napi_value SendableImageReceiverNapi::JsGetFormat(napi_env env, napi_callback_info info)
{
    IMAGE_FUNCTION_IN();
    SendableImageReceiverCommonArgs args = {
        .env = env, .info = info,
...
napi_value SendableImageReceiverNapi::JsTest(napi_env env, napi_callback_info info)
{
    IMAGE_FUNCTION_IN();
    SendableImageReceiverCommonArgs args = {
        .env = env, .info = info,
...
napi_value SendableImageReceiverNapi::JsCheckDeviceTest(napi_env env, napi_callback_info info)
{
    IMAGE_FUNCTION_IN();
    SendableImageReceiverCommonArgs args = {
        .env = env, .info = info,
...
napi_value SendableImageReceiverNapi::JsTestYUV(napi_env env, napi_callback_info info)
{
    IMAGE_FUNCTION_IN();
    SendableImageReceiverCommonArgs args = {
        .env = env, .info = info,
...
napi_value SendableImageReceiverNapi::JsGetReceivingSurfaceId(napi_env env, napi_callback_info info)
{
    IMAGE_FUNCTION_IN();
    SendableImageReceiverCommonArgs args = {
        .env = env, .info = info,
...
napi_value SendableImageReceiverNapi::JsReadLatestImage(napi_env env, napi_callback_info info)
{
    IMAGE_FUNCTION_IN();
    SendableImageReceiverCommonArgs args = {
        .env = env, .info = info,
...
#endif
        napi_value result = SendableImageNapi::Create(env, image);
        if (result == nullptr) {
            IMAGE_ERR("SendableImageNapi Create is nullptr");
            FailedCallbackRoutine(env, context, ERR_IMAGE_INIT_ABNORMAL);
            return;
        }
        context->status = SUCCESS;
...
napi_value SendableImageReceiverNapi::JsReadNextImage(napi_env env, napi_callback_info info)
{
    IMAGE_FUNCTION_IN();
    SendableImageReceiverCommonArgs args = {
        .env = env, .info = info,
...
static bool JsOnQueryArgs(SendableImageReceiverCommonArgs &args, SendableImageReceiverInnerContext &ic)
{
    if (ic.argc == ARGS2) {
...
napi_value SendableImageReceiverNapi::JsOn(napi_env env, napi_callback_info info)
{
    IMAGE_FUNCTION_IN();
    SendableImageReceiverCommonArgs args = {
        .env = env, .info = info,
...
napi_value SendableImageReceiverNapi::JsRelease(napi_env env, napi_callback_info info)
{
    IMAGE_FUNCTION_IN();
    SendableImageReceiverCommonArgs args = {
        .env = env, .info = info,
...
void SendableImageReceiverNapi::release()
{
    if (!isRelease) {
        NativeRelease();
        isRelease = true;

...
#ifndef INTERFACES_KITS_NATIVE_INCLUDE_IMAGE_COMMON_H
#define INTERFACES_KITS_NATIVE_INCLUDE_IMAGE_COMMON_H
#include <stdint.h>
...
#endif // INTERFACES_KITS_NATIVE_INCLUDE_IMAGE_COMMON_H
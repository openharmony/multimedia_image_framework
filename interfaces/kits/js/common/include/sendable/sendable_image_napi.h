...
#ifndef INTERFACES_KITS_JS_COMMON_INCLUDE_IMAGE_SENDABLE_NAPI_H
#define INTERFACES_KITS_JS_COMMON_INCLUDE_IMAGE_SENDABLE_NAPI_H
...
private:
    ...
    friend struct SendableImageAsyncContext;
};

} // namespace Media
} // namespace OHOS

#endif //INTERFACES_KITS_JS_COMMON_INCLUDE_IMAGE_SENDABLE_NAPI_H
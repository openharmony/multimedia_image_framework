...
#ifndef INTERFACES_KITS_JS_COMMON_INCLUDE_SENDABLE_IMAGE_RECEIVER_NAPI_H
#define INTERFACES_KITS_JS_COMMON_INCLUDE_SENDABLE_IMAGE_RECEIVER_NAPI_H
...
namespace OHOS {
namespace Media {
struct SendableImageReceiverCommonArgs;
struct SendableImageReceiverAsyncContext;
...
struct SendableImageReceiverCreateArgs {
    int32_t width;
    int32_t height;
    int32_t format;
    int32_t capicity;
};
class SendableImageReceiverNapi {
public:
...
struct SendableImageReceiverAsyncContext {
    ...
    SendableImageReceiverNapi *constructor_ = nullptr;
    uint32_t status;
};
struct SendableImageReceiverInnerContext {
    napi_status status;
    ...
    std::string onType;
    int32_t refCount = 1;
    std::unique_ptr<SendableImageReceiverAsyncContext> context = nullptr;
};

using CommonFunc = bool (*)(SendableImageReceiverCommonArgs &args, SendableImageReceiverInnerContext &ic);
...
public:
    ...
    {
        SendableImageReceiverNapi::DoCallBack(context, name, callBack);
    }
    std::shared_ptr<SendableImageReceiverAsyncContext> context = nullptr;
    std::string name;
    CompleteCallback callBack = nullptr;
};
} // namespace Media
} // namespace OHOS
#endif // INTERFACES_KITS_JS_COMMON_INCLUDE_SENDABLE_IMAGE_RECEIVER_NAPI_H

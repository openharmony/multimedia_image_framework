...
#ifndef INTERFACES_KITS_JS_COMMON_INCLUDE_IMAGE_PACKER_NAPI_H
#define INTERFACES_KITS_JS_COMMON_INCLUDE_IMAGE_PACKER_NAPI_H
...
private:
    ...
    static napi_value PackBinaryImageToTiffFile(napi_env env, napi_callback_info info);
    static napi_value PackBinaryImageToTiffData(napi_env env, napi_callback_info info);
